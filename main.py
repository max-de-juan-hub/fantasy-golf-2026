...
def load_data(conn):
    ...
    # --- ROBUST DATE PARSING ---
    # Try parsing with dayfirst=True (International format)
    # If a date is ambiguous (e.g. 2026-10-01 could be Oct 1 or Jan 10), pandas defaults to Month first if not specified.
    # But since you enter data via Streamlit (YYYY-MM-DD), it should be consistent.
    # The issue likely happened if data was edited manually in Sheets.
